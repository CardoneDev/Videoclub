        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8 display-4 text-center"id="bienvenida">
                    Bienvenido/a <%out.print(session.getAttribute("correo"));%>
                </div>
                <div class="col-12">
                    <center class="text" style="font-weight:bold;margin-bottom: 8px;font-size: 26pt;">Top Descuento Peliculas</center>
                    <table class="table table-dark" style="color: white">
                        ...
                        <tbody>
                            <c:forEach var="Listatop8peli" items="${listadoprova}">
                                <tr>
                                    <th scope="row"><img src="${Listatop8peli.imagen}"></td><td> ${Listatop8peli.titulo}</td><td> ${Listatop8peli.precio}€</td><td> ${Listatop8peli.descuento}%</td>
                                </tr>
                            </c:forEach>
                ...
                <div class="col-12">
                    <center class="text" style="font-weight:bold;margin-bottom: 8px;font-size: 26pt;">Top Descuento Videojuegos</center>
                    <table class="table table-dark" style="color: white">
                        <thead>
                            <tr>
                                <th scope="col"></th>
                        ...
                        <tbody>
                            <c:forEach var="Listatop8video" items="${listadoprova2}">
                                <tr>
                                    <th scope="row"><img src="${Listatop8video.imagen}"></td><td> ${Listatop8video.titulo}</td><td> ${Listatop8video.precio}€</td><td> ${Listatop8video.descuento}%</td>
                                </tr>
                            </c:forEach>
