...
<html lang="en">
    ...
    <body>
        ...
        <div class="container ">
            <div class="row">
                <!--Aqui va el taglist-->
                <c:forEach var="Lista" items="${infopeli}">
                    ...
                    <div class="col-6 bg-dark pt-4 pb-4" style="margin-top:50px;opacity: 0.8">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 text-light">Director: ${Lista.director}</div>
                            <div class="col-12 mt-4 text-light">Año de Estreno: ${Lista.anio}</div>
                            <div class="col-12 mt-4 text-light">Genero: ${Lista.genero}</div>
                            ...
                            <a href="log?control=peliculas" class="btn btn-outline-danger mt-4">Vuelve a Peliculas</a>
                            <a href="log?control=anadecarritopeli&idpeli=${Lista.id}" class="btn btn-outline-warning mt-4 ml-4">A&ntilde;ade al carrito</a>
                        </div>
                    </div>
                </c:forEach>
