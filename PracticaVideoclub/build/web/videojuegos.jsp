            ...
            <div class="col" style="margin-top:50px;">
                <table class="table table-dark">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="Lista" items="${listadovideojuegos}">
                            <tr class="text-center-row">
                                <th scope="row"><a href="log?control=descripcionvideo&id=${Lista.id}"><img class="img-fluid" src="${Lista.imagen}"></a></th>
                                <td>${Lista.titulo}</td>
                                <td>${Lista.empresa}</td>
                                <td>${Lista.descuento}%</td>
                                <td>${Lista.precio}€</td>
                                <td><a class="btn btn-outline-warning" href="log?control=anadecarritovideo&idvideo=${Lista.id}&tipo=${Lista.tipo}">A&ntilde;ade al carrito</a></td>
                            </tr>
                        </c:forEach>
